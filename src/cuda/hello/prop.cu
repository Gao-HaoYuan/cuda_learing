...
void printDeviceProperties() {
    ...
    for (int device = 0; device < deviceCount; ++device) {
        ...
        std::cout << "Compute Capability: " << prop.major << "." << prop.minor
                  << std::endl;
        std::cout << "Multi-Processor Count (SMs): " << prop.multiProcessorCount
                  << std::endl;
        ...
        std::cout << "Global Memory (MB): "
                  << prop.totalGlobalMem / (1024 * 1024) << std::endl;
        std::cout << "Shared Memory Per Block (KB): "
                  << prop.sharedMemPerBlock / 1024 << std::endl;
        ...
        std::cout << "L2 Cache Size (KB): " << prop.l2CacheSize / 1024
                  << std::endl;
